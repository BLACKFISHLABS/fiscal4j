...
public class CteRecepcaoOSStub extends org.apache.axis2.client.Stub {
    ...
    public br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult cteRecepcaoOS(final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
     ...
     * @param cteCabecMsg1
     */
    public void startcteRecepcaoOS(final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE cteCabecMsg1, final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS/cteRecepcaoOS");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg param, final boolean optimizeContent) {
        //try {
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult param, final boolean optimizeContent) {
        //try {
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE param, final boolean optimizeContent) {
        //try {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //try {

...
import br.indie.fiscal4j.nfe.classes.cadastro.NFIndicadorContribuinteCTe;
import br.indie.fiscal4j.nfe.classes.cadastro.NFIndicadorContribuinteNFe;
...
public class NFRegistryMatcher extends RegistryMatcher {
    ...
    public NFRegistryMatcher() {
        ...
        super.bind(DFModelo.class, new NFModeloTransformer());
        super.bind(NFOrigem.class, new NFOrigemTransformer());
        super.bind(DFAmbiente.class, new NFAmbienteTransformer());
        ...
        super.bind(DFUnidadeFederativa.class, new NFUnidadeFederativaTransformer());

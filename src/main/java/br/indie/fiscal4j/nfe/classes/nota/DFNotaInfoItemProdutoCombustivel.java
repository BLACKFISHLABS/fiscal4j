...
public class DFNotaInfoItemProdutoCombustivel extends DFBase {
    ...
    private DFNotaInfoItemProdutoCombustivelCIDE cide;

    public DFNotaInfoItemProdutoCombustivel() {
    ...
    public void setCide(final DFNotaInfoItemProdutoCombustivelCIDE cide) {
        this.cide = cide;
    }
    ...
    public DFNotaInfoItemProdutoCombustivelCIDE getCide() {
        return this.cide;
    }
}
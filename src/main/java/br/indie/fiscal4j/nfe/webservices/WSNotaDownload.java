...
import br.indie.fiscal4j.nfe.classes.evento.downloadnf.NFDownloadNFe;
...
import br.indie.fiscal4j.nfe.webservices.downloadnf.NfeDownloadNFStub;
import br.indie.fiscal4j.nfe.webservices.downloadnf.NfeDownloadNFStub.NfeCabecMsg;
import br.indie.fiscal4j.nfe.webservices.downloadnf.NfeDownloadNFStub.NfeCabecMsgE;
import br.indie.fiscal4j.nfe.webservices.downloadnf.NfeDownloadNFStub.NfeDadosMsg;
import br.indie.fiscal4j.nfe.webservices.downloadnf.NfeDownloadNFStub.NfeDownloadNFResult;
...
class WSNotaDownload {
    ...
    private OMElement efetuaDownloadNF(OMElement omElementConsulta) throws RemoteException {
        ...
        NFAutorizador4 autorizador = NFAutorizador4.valueOfCodigoUF(this.config.getCUF());

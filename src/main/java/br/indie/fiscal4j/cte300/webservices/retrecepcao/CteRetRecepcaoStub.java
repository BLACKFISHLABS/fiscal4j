...
public class CteRetRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult cteRetRecepcao(final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult) object;
     ...
     * @param cteCabecMsg1
     */
    public void startcteRetRecepcao(final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE cteCabecMsg1, final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRetRecepcao/cteRetRecepcao");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteRetRecepcaoStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult.class, CteRetRecepcaoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteRetRecepcao((br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //        try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

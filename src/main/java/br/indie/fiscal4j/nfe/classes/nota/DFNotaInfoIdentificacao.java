...
public class DFNotaInfoIdentificacao extends DFBase {
    ...
    private List<DFInfoReferenciada> referenciadas;
    ...
    public void setReferenciadas(final List<DFInfoReferenciada> referenciadas) {
    ...
    public List<DFInfoReferenciada> getReferenciadas() {

...
public class DFNotaInfoItemProdutoDeclaracaoImportacao extends DFBase {
    ...
    private List<DFNotaInfoItemProdutoDeclaracaoImportacaoAdicao> adicoes;
    ...
    public void setAdicoes(final List<DFNotaInfoItemProdutoDeclaracaoImportacaoAdicao> adicoes) {
    ...
    public List<DFNotaInfoItemProdutoDeclaracaoImportacaoAdicao> getAdicoes() {
        return this.adicoes;
    }
}
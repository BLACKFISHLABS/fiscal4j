...
public class NFNotaInfoTransporteTest {
    ...
    public void devePermitirVolumesComTamanhoInvalido() {
        final List<DFNotaInfoVolume> volumes = new ArrayList<>();
        for (int i = 0; i < 5000; i++) {
            volumes.add(new DFNotaInfoVolume());
        }
        new DFNotaInfoTransporte().setVolumes(volumes);
    }

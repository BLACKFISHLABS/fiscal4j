package br.indie.fiscal4j.cte300.webservices.recepcaoevento;
...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
    ...
    public br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult cteRecepcaoEvento(final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult) object;
     ...
     * @param cteCabecMsg1
     */
    public void startcteRecepcaoEvento(final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE cteCabecMsg1, final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento/cteRecepcaoEvento");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = RecepcaoEventoStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult.class, RecepcaoEventoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteRecepcaoEvento((br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //        try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

 ...
 */
package br.indie.fiscal4j.cte300.webservices.recepcaoOS;
...
public class CteRecepcaoOSStub extends org.apache.axis2.client.Stub {
    ...
    public br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult cteRecepcaoOS(

            final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE cteCabecMsg1)
...

    {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.class, this.getEnvelopeNamespaces(_returnEnv));

            return (br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult) object;
    ...
    public void startcteRecepcaoOS(
            ...
            final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSCallbackHandler callback)
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteRecepcaoOSStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.class, CteRecepcaoOSStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteRecepcaoOS((br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg param, final boolean optimizeContent) throws org.apache.axis2.AxisFault {

        try {
            return param.getOMElement(br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult param, final boolean optimizeContent) throws org.apache.axis2.AxisFault {

        try {
            return param.getOMElement(br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (final org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE param, final boolean optimizeContent) throws org.apache.axis2.AxisFault {

        try {
            return param.getOMElement(br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (final org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) throws org.apache.axis2.AxisFault {

        try {

            final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            emptyEnvelope.getBody().addChild(param.getOMElement(br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        ...
        try {
            ...
            if (br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg.class.equals(type)) {

                return br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());

            }

            if (br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.class.equals(type)) {

                return br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());

            }

            if (br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE.class.equals(type)) {

                return br.indie.fiscal4j.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());

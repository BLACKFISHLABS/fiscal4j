 ...
 */
package br.indie.fiscal4j.nfe400.webservices.consultacadastro.svrs;
...
public class CadConsultaCadastro4Stub extends org.apache.axis2.client.Stub {
    ...
    public CadConsultaCadastro4Stub.NfeResultMsg consultaCadastro(final CadConsultaCadastro4Stub.ConsultaCadastro consultaCadastro0) throws java.rmi.RemoteException {
     ...
     *
     * @param consultaCadastro0
     * @see CadConsultaCadastro4#startconsultaCadastro
     */
    public void startconsultaCadastro(final CadConsultaCadastro4Stub.ConsultaCadastro consultaCadastro0, final CadConsultaCadastro4CallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4/consultaCadastro");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final CadConsultaCadastro4Stub.ConsultaCadastro param, final boolean optimizeContent, final javax.xml.namespace.QName elementQName) throws org.apache.axis2.AxisFault {
        try {
    ...
    public static class ConsultaCadastroResult_type0 implements org.apache.axis2.databinding.ADBBean {
        /*
         * This type was generated from the piece of schema that had name = consultaCadastroResult_type0 Namespace URI = http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4 Namespace Prefix = ns1
         */
    ...
    public static class NfeDadosMsg_type0 implements org.apache.axis2.databinding.ADBBean {
        /*
         * This type was generated from the piece of schema that had name = nfeDadosMsg_type0 Namespace URI = http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4 Namespace Prefix = ns1
         */

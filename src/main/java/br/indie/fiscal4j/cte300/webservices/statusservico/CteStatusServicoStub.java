package br.indie.fiscal4j.cte300.webservices.statusservico;
...
public class CteStatusServicoStub extends org.apache.axis2.client.Stub {
    ...
    public br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult cteStatusServicoCT(final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult) object;
     ...
     * @param cteCabecMsg1
     */
    public void startcteStatusServicoCT(final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg cteDadosMsg0, final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteCabecMsgE cteCabecMsg1, final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteStatusServico/cteStatusServicoCT");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteStatusServicoStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult.class, CteStatusServicoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteStatusServicoCT((br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //        try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteCabecMsgE.class.equals(type)) {
                return br.indie.fiscal4j.cte300.webservices.statusservico.CteStatusServicoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

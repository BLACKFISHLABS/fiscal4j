...
public class DFNotaInfoCana extends DFBase {
    ...
    private List<DFNotaInfoCanaFornecimentoDiario> fornecimentosDiario;

    @ElementList(entry = "deduc", inline = true, required = false)
    private List<DFNotaInfoCanaDeducao> deducoes;
    ...
    public void setFornecimentosDiario(final List<DFNotaInfoCanaFornecimentoDiario> fornecimentosDiario) {
        ListValidador.tamanho31Obrigatorio(fornecimentosDiario, "Fornecimento Diario");
        this.fornecimentosDiario = fornecimentosDiario;
    }

    public void setDeducoes(final List<DFNotaInfoCanaDeducao> deducoes) {
    ...
    public List<DFNotaInfoCanaFornecimentoDiario> getFornecimentosDiario() {
        return this.fornecimentosDiario;
    }

    public List<DFNotaInfoCanaDeducao> getDeducoes() {

...
public class DFLoteEnvioRetorno extends DFBase {
    ...
    private DFLoteEnvioRetornoRecebimentoInfo infoRecebimento;
    ...
    public DFLoteEnvioRetornoRecebimentoInfo getInfoRecebimento() {
        return this.infoRecebimento;
    }

    public void setInfoRecebimento(final DFLoteEnvioRetornoRecebimentoInfo infoRecebimento) {

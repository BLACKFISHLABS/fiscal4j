...
public class NFNotaInfoItemProdutoDeclaracaoImportacaoTest {
    ...
    public void naoDevePermitiyrCNPJComTamanhoInvalido() {
        try {
            new DFNotaInfoItemProdutoDeclaracaoImportacao().setCnpj("1234567890123");
        } catch (final IllegalStateException e) {
            new DFNotaInfoItemProdutoDeclaracaoImportacao().setCnpj("123456789012345");
        }
    }
    ...
    public void naoDevePermitirCodigoExportadorComTamanhoInvalido() {
        try {
            new DFNotaInfoItemProdutoDeclaracaoImportacao().setCodigoExportador("");
        } catch (final IllegalStateException e) {
            new DFNotaInfoItemProdutoDeclaracaoImportacao().setCodigoExportador("kiVfWKB94ggsrWND0XBXwEjJkoiTXhkmX9qKGKzjpnEHHp852bDkYeEUkzpU1");
        }
    }
    ...
    public void naoDevePermitirLocalDesembaracoComTamanhoInvalido() {
        try {
            new DFNotaInfoItemProdutoDeclaracaoImportacao().setLocalDesembaraco("");
        } catch (final IllegalStateException e) {
            new DFNotaInfoItemProdutoDeclaracaoImportacao().setLocalDesembaraco("kiVfWKB94ggsrWND0XBXwEjJkoiTXhkmX9qKGKzjpnEHHp852bDkYeEUkzpU1");
        }
    }
    ...
    public void naoDevePermitirNumeroRegistroComTamanhoInvalido() {
        try {
            new DFNotaInfoItemProdutoDeclaracaoImportacao().setNumeroRegistro("");
        } catch (final IllegalStateException e) {
            new DFNotaInfoItemProdutoDeclaracaoImportacao().setNumeroRegistro("ZRJihqWLyHnb1");
        }
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        final String xmlEsperado = "<DFNotaInfoItemProdutoDeclaracaoImportacao><nDI>ZRJihqWLyHnb</nDI><dDI>2014-02-02</dDI><xLocDesemb>kiVfWKB94ggsrWND0XBXwEjJkoiTXhkmX9qKGKzjpnEHHp852bDkYeEUkzpU</xLocDesemb><UFDesemb>RS</UFDesemb><dDesemb>2014-01-01</dDesemb><tpViaTransp>4</tpViaTransp><vAFRMM>999999999999.99</vAFRMM><tpIntermedio>3</tpIntermedio><CNPJ>12345678901234</CNPJ><UFTerceiro>RS</UFTerceiro><cExportador>E9jBqM65b0MiCiRnYil203iNGJOSZs8iU1KGmQsj2N0kw6QMuvhbsQosFGcU</cExportador><adi><nAdicao>999</nAdicao><nSeqAdic>999</nSeqAdic><cFabricante>sA2FBRFMMNgF1AKRDDXYOlc3zGvzEc69l6zQ5O5uAUe82XZ3szQfw01DW0Ki</cFabricante><vDescDI>999999999999.99</vDescDI><nDraw>99999999999</nDraw></adi></DFNotaInfoItemProdutoDeclaracaoImportacao>";

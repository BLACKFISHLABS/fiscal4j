...
public class DFNotaInfoVolume extends DFBase {
    ...
    private List<DFNotaInfoLacre> lacres;
    ...
    public void setLacres(final List<DFNotaInfoLacre> lacres) {
    ...
    public List<DFNotaInfoLacre> getLacres() {
        return this.lacres;
    }
}
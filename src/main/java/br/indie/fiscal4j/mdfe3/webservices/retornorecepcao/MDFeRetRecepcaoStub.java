...
public class MDFeRetRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeRetRecepcaoResult mdfeRetRecepcao(final br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0, final br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeRetRecepcaoResult.class, this.getEnvelopeNamespaces(_returnEnv));
     ...
     * @param mdfeCabecMsg1
     */
    public void startmdfeRetRecepcao(final br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0, final br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1, final br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRetRecepcao/mdfeRetRecepcao");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeRetRecepcaoStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeRetRecepcaoResult.class, MDFeRetRecepcaoStub.this.getEnvelopeNamespaces(resultEnv));
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        // try {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.indie.fiscal4j.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        // try {

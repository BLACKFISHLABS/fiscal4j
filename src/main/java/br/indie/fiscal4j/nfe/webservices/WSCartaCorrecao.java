...
import br.indie.fiscal4j.nfe.classes.evento.NFEnviaEventoRetorno;
...
import br.indie.fiscal4j.nfe.webservices.gerado.RecepcaoEventoStub;
import br.indie.fiscal4j.nfe.webservices.gerado.RecepcaoEventoStub.NfeCabecMsg;
import br.indie.fiscal4j.nfe.webservices.gerado.RecepcaoEventoStub.NfeCabecMsgE;
import br.indie.fiscal4j.nfe.webservices.gerado.RecepcaoEventoStub.NfeDadosMsg;
import br.indie.fiscal4j.nfe.webservices.gerado.RecepcaoEventoStub.NfeRecepcaoEventoResult;
...
class WSCartaCorrecao {
    ...
    private OMElement efetuaCorrecao(final String xmlAssinado, final String chaveAcesso) throws XMLStreamException, RemoteException {
        ...
        final NFAutorizador4 autorizacao = NFAutorizador4.valueOfCodigoUF(this.config.getCUF());

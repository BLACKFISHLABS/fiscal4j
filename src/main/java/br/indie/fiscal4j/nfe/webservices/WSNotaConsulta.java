...
import br.indie.fiscal4j.nfe.webservices.gerado.NfeConsulta2Stub.NfeConsultaNF2Result;
import br.indie.fiscal4j.nfe.webservices.nota.consulta.NfeConsultaStub;
import br.indie.fiscal4j.nfe.webservices.nota.consulta.NfeConsultaStub.NfeConsultaNFResult;
...
class WSNotaConsulta {
    ...
    private OMElement efetuaConsulta(final OMElement omElementConsulta, final String chaveDeAcesso) throws Exception {
        ...
        boolean consultaNFeBahia = DFUnidadeFederativa.BA.equals(notaFiscalChaveParser.getNFUnidadeFederativa()) && DFModelo.NFE.equals(notaFiscalChaveParser.getModelo());
        if (consultaNFeBahia) {
    ...
    private OMElement efetuaConsultaSVRS(final OMElement omElementConsulta, final String chaveDeAcesso) throws RemoteException {
        ...
        NFAutorizador4 autorizador = NFAutorizador4.valueOfChaveAcesso(chaveDeAcesso);

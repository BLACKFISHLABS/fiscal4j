...
public class DFNotaInfoItemProduto extends DFBase {
    ...
    private List<DFNotaInfoItemProdutoDeclaracaoImportacao> declaracoesImportacao;

    @ElementList(entry = "detExport", inline = true, required = false)
    private List<DFNotaInfoItemDetalheExportacao> detalhesExportacao;
    ...
    private DFNotaInfoItemProdutoVeiculo veiculo;

    @ElementList(entry = "med", inline = true, required = false)
    private List<DFNotaInfoItemProdutoMedicamento> medicamentos;

    @ElementList(entry = "arma", inline = true, required = false)
    private List<DFNotaInfoItemProdutoArmamento> armamentos;

    @Element(name = "comb", required = false)
    private DFNotaInfoItemProdutoCombustivel combustivel;
    ...
    public void setDeclaracoesImportacao(final List<DFNotaInfoItemProdutoDeclaracaoImportacao> declaracoesImportacao) {
    ...
    public void setVeiculo(final DFNotaInfoItemProdutoVeiculo veiculo) {
    ...
    public void setMedicamentos(final List<DFNotaInfoItemProdutoMedicamento> medicamentos) {
    ...
    public void setArmamentos(final List<DFNotaInfoItemProdutoArmamento> armamentos) {
    ...
    public void setCombustivel(final DFNotaInfoItemProdutoCombustivel combustivel) {
    ...
    public void setDetalhesExportacao(final List<DFNotaInfoItemDetalheExportacao> detalhesExportacao) {
    ...
    public List<DFNotaInfoItemProdutoDeclaracaoImportacao> getDeclaracoesImportacao() {
        return this.declaracoesImportacao;
    }

    public List<DFNotaInfoItemDetalheExportacao> getDetalhesExportacao() {
    ...
    public DFNotaInfoItemProdutoVeiculo getVeiculo() {
        return this.veiculo;
    }

    public List<DFNotaInfoItemProdutoMedicamento> getMedicamentos() {
        return this.medicamentos;
    }

    public List<DFNotaInfoItemProdutoArmamento> getArmamentos() {
        return this.armamentos;
    }

    public DFNotaInfoItemProdutoCombustivel getCombustivel() {

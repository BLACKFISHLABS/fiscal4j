...
public class MDFeRecepcaoEventoStub extends org.apache.axis2.client.Stub {
    ...
    public br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult mdfeRecepcaoEvento(final br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg mdfeDadosMsg0, final br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult.class, this.getEnvelopeNamespaces(_returnEnv));
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeRecepcaoEventoStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult.class, MDFeRecepcaoEventoStub.this.getEnvelopeNamespaces(resultEnv));
    ...
    @SuppressWarnings("unused")
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg param, final boolean optimizeContent) {
        // try {
    ...
    @SuppressWarnings("unused")
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult param, final boolean optimizeContent) {
        // try {
    ...
    private org.apache.axiom.om.OMElement toOM(final br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        // try {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.indie.fiscal4j.mdfe3.webservices.recepcaoevento.MDFeRecepcaoEventoStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        // try {
